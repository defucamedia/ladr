System.config({
  ...
  bundles: {
    ...
    "app-build": [
      ...
      "testimonials.html!github:systemjs/plugin-text@0.0.2",
      "projects.html!github:systemjs/plugin-text@0.0.2",
      "project.html!github:systemjs/plugin-text@0.0.2",
      "profile.html!github:systemjs/plugin-text@0.0.2",
      "nav-bar.html!github:systemjs/plugin-text@0.0.2",
      "heading.html!github:systemjs/plugin-text@0.0.2",
      "contact.html!github:systemjs/plugin-text@0.0.2",
      "awards.html!github:systemjs/plugin-text@0.0.2",
      "app.html!github:systemjs/plugin-text@0.0.2",
      "about.html!github:systemjs/plugin-text@0.0.2",
      "projects",
      "github:aurelia/framework@0.16.0",
      "github:aurelia/fetch-client@0.2.0",
      ...
      "github:aurelia/framework@0.16.0/aurelia-framework",
      "github:aurelia/fetch-client@0.2.0/aurelia-fetch-client",
      "github:aurelia/dialog@0.3.0/index",
      "github:aurelia/event-aggregator@0.8.0/aurelia-event-aggregator",
      ...
      "github:aurelia/metadata@0.8.0",
      "github:aurelia/task-queue@0.7.0",
      "github:aurelia/dialog@0.3.0/dialog",
      "github:aurelia/dialog@0.3.0/dialog-header",
      "github:aurelia/dialog@0.3.0/dialog-body",
      "github:aurelia/dialog@0.3.0/dialog-footer",
      "github:aurelia/dialog@0.3.0/attach-focus",
      "github:aurelia/dialog@0.3.0/dialog-service",
      "github:aurelia/dialog@0.3.0/dialog-controller",
      "npm:core-js@0.9.18/client/shim.min",
      "github:aurelia/logging@0.7.0/aurelia-logging",
      "github:aurelia/templating@0.15.3/aurelia-templating",
      "github:aurelia/path@0.9.0/aurelia-path",
      ...
      "github:aurelia/metadata@0.8.0/aurelia-metadata",
      "github:aurelia/task-queue@0.7.0/aurelia-task-queue",
      "github:aurelia/dialog@0.3.0/dialog-renderer",
      "github:aurelia/dialog@0.3.0/lifecycle",
      "github:jspm/nodelibs-process@0.1.2",
      "github:zloirock/core-js@0.8.4",
      "github:jspm/nodelibs-process@0.1.2/index",
      "github:zloirock/core-js@0.8.4/index",
